<template>
  <div id="app" style="margin: 100px;">
    ...
    <b-uploader multiple :size="1024 * 1024 * 2" accept="image/PNG" @error="error = $event" action="http://localhost:3000/upload" name="file" method="POST" :parseUrl="parseUrl" :fileList.sync="fileList">
      <b-button>
