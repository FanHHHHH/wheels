<template>
  <div id="app" style="margin: 100px;">
    <b-table expandField="description" indexIsVisable :index-is-visable="false" :height="300" bordered :selected-items.sync="selected" :data-source="dataSource" :columns="columns" :order-by.sync="orderBy" @update:orderBy="x" :loading="loading"></b-table>
